...
func AddSnapshot(nodeID string, values []Snapshot) error{
	...
	for _, value := range values {
		cluster := MakeCluster(value.ClusterName, value.CertFilePath, value.KeyFilePath, value.CAFilePath, value.EndPoints)
		route := MakeRoute(value.RouteName, value.ClusterName, value.ListenerHost)
		listener := MakeHTTPListener(value.ListenerHost, value.ListenerPort, value.ListenerName, value.ClusterName, value.RouteName, value.CertFilePath, value.KeyFilePath, value.CAFilePath)
