...
import (
	...
	"github.com/davecourtois/Globular/services/golang/smtp/smtp_client"
...
func main() {
	...
	s_impl.Name = string(smtppb.File_services_proto_smtp_proto.Services().Get(0).FullName())
	s_impl.Proto = smtppb.File_services_proto_smtp_proto.Path()
	s_impl.Port = port
