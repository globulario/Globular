...
export class Connection extends jspb.Message {
  ...
  getType(): StoreType;
  setType(value: StoreType): Connection;
...
export class OpenRqst extends jspb.Message {
  getId(): string;
  setId(value: string): OpenRqst;

  getOptions(): string;
  setOptions(value: string): OpenRqst;
...
export class OpenRsp extends jspb.Message {
  getResult(): boolean;
  setResult(value: boolean): OpenRsp;
...
export class SetItemRequest extends jspb.Message {
  getId(): string;
  setId(value: string): SetItemRequest;

  getKey(): string;
  setKey(value: string): SetItemRequest;

  getValue(): Uint8Array | string;
  getValue_asU8(): Uint8Array;
  getValue_asB64(): string;
  setValue(value: Uint8Array | string): SetItemRequest;
...
export class SetItemResponse extends jspb.Message {
  getResult(): boolean;
  setResult(value: boolean): SetItemResponse;
...
export class GetItemRequest extends jspb.Message {
  ...
  getKey(): string;
  setKey(value: string): GetItemRequest;
...
export class GetItemResponse extends jspb.Message {
  ...
  setResult(value: Uint8Array | string): GetItemResponse;
...
export class RemoveItemRequest extends jspb.Message {
  getId(): string;
  setId(value: string): RemoveItemRequest;

  getKey(): string;
  setKey(value: string): RemoveItemRequest;
...
export class RemoveItemResponse extends jspb.Message {
  getResult(): boolean;
  setResult(value: boolean): RemoveItemResponse;
...
export class ClearRequest extends jspb.Message {
  getId(): string;
  setId(value: string): ClearRequest;
...
export class ClearResponse extends jspb.Message {
  getResult(): boolean;
  setResult(value: boolean): ClearResponse;
...
export class DropRequest extends jspb.Message {
  getId(): string;
  setId(value: string): DropRequest;
...
export class DropResponse extends jspb.Message {
  getResult(): boolean;
  setResult(value: boolean): DropResponse;
