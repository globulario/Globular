...
export class ServerInfo extends jspb.Message {
  getId(): string;
  setId(value: string): ServerInfo;

  getName(): string;
  setName(value: string): ServerInfo;

  getDomain(): string;
  setDomain(value: string): ServerInfo;
...
export class LoadInfo extends jspb.Message {
  ...
  setServerinfo(value?: ServerInfo): LoadInfo;
  hasServerinfo(): boolean;
  clearServerinfo(): LoadInfo;

  getLoad1(): number;
  setLoad1(value: number): LoadInfo;

  getLoad5(): number;
  setLoad5(value: number): LoadInfo;

  getLoad15(): number;
  setLoad15(value: number): LoadInfo;
...
export class GetCanditatesRequest extends jspb.Message {
  ...
  setServicename(value: string): GetCanditatesRequest;
...
export class GetCanditatesResponse extends jspb.Message {
  ...
  setServersList(value: Array<ServerInfo>): GetCanditatesResponse;
  clearServersList(): GetCanditatesResponse;
...
export class ReportLoadInfoRequest extends jspb.Message {
  ...
  setInfo(value?: LoadInfo): ReportLoadInfoRequest;
  hasInfo(): boolean;
  clearInfo(): ReportLoadInfoRequest;
