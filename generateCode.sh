...
protoc services/proto/ca.proto --go_out=plugins=grpc:./services/golang
protoc services/proto/lb.proto --go_out=plugins=grpc:./services/golang
protoc services/proto/services.proto --go_out=plugins=grpc:./services/golang
protoc services/proto/dns.proto --go_out=plugins=grpc:./services/golang
protoc services/proto/echo.proto --go_out=plugins=grpc:./services/golang
protoc services/proto/search.proto --go_out=plugins=grpc:./services/golang
protoc services/proto/event.proto --go_out=plugins=grpc:./services/golang
protoc services/proto/storage.proto --go_out=plugins=grpc:./services/golang
...
protoc services/proto/spc.proto --go_out=plugins=grpc:./services/golang
protoc services/proto/catalog.proto --go_out=plugins=grpc:./services/golang
protoc services/proto/plc_link.proto --go_out=plugins=grpc:./services/golang

# TypeScript grpc files generation.
mkdir services/typescript/admin
...
mkdir services/typescript/ressource
...
mkdir services/typescript/services
...
mkdir services/typescript/echo
...
mkdir services/typescript/search
...
mkdir services/typescript/event
...
mkdir services/typescript/storage
...
mkdir services/typescript/file
...
mkdir services/typescript/monitoring
...
mkdir services/typescript/plc_link
...
mkdir services/typescript/catalog
