...
protoc monitoring/monitoringpb/monitoring.proto --grpc-web_out=import_style=commonjs,mode=grpcwebtext:client
...
protoc catalog/catalogpb/catalog.proto --grpc-web_out=import_style=commonjs,mode=grpcwebtext:client