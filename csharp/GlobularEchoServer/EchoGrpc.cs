...
namespace Echo {
  public static partial class EchoService
  {
    ...
    static readonly grpc::Marshaller<global::Echo.EchoRequest> __Marshaller_echo_EchoRequest = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Echo.EchoRequest.Parser.ParseFrom);
    static readonly grpc::Marshaller<global::Echo.EchoResponse> __Marshaller_echo_EchoResponse = grpc::Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::Echo.EchoResponse.Parser.ParseFrom);
