...
var Globular = /** @class */ (function () {
    ...
    function Globular(config) {
        ...
        if (this.config.Services["plc_server_ab"] != null) {
            this.plcService_ab = new plc_grpc_web_pb_1.PlcServiceClient(this.config.Protocol +
                "://" +
                this.config.Domain +
                ":" +
        ...
        if (this.config.Services["plc_server_simens"] != null) {
            this.plcService_simens = new plc_grpc_web_pb_1.PlcServiceClient(this.config.Protocol +
                "://" +
                this.config.Domain +
                ":" +
